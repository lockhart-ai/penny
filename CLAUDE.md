...
- **Lifecycle**: relay merge/close events so children run their §9 cleanup; file the follow-up issues children report as out-of-scope findings. **A finished child session is verified, marked complete, and archived** (runbook §5) — children are visible Nimbalyst sessions, and unarchived ones pile up in the session list.
