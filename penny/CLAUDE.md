...
penny/
  ...
  text_validity.py    — Content-validity predicates (degenerate/blank/half-formed-send), dependency-light leaf shared by the memory write path, the send_message validator, and the run-health classifier
  tests/
