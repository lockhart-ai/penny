...
def test_shape_system_prompt_whole_render():
    ...
    assert SKILL_SHAPE_SYSTEM_PROMPT == (
        ...
        "asked for once, and the values used to carry it out that time. Do three "
        "things:\n"
        ...
        "folder': a routine named 'file receipts' needs only the sender and the "
        "folder next time, because receipts is what it IS (CONSTANT) — while a "
        "routine named 'file emails into a folder' needs all three. Both are real "
        "routines, and which one you named in step 2 decides which answer is "
        "right.\n"
        ...
        "it a record of what happened rather than a routine.\n"
