...
The machine is parked on one question -- the value the previous ask was short of -- and the user answers it.  The turn composes the answer with what the original ask already settled, rather than treating the reply as a fresh instruction or re-asking for what it already holds.
"""
...
from penny.tests.eval.utils.transition_world import _PARKED_MESSAGE_WINDOW, _RequestApplyCase, _SUPPLIED_BAKERY, _SUPPLIED_COUNT, _SUPPLIED_LISTING, _SUPPLIED_PIER, _SUPPLIED_SPACES, _SUPPLIED_TIMETABLE, _bound_parameters_check, _derived_container, _enactment_binding_check, _fresh_mint_check, _job_setup_advisories, _job_stood_up_checks, _job_terms_checks, _landed_apply_move, _mentions_any, _minted_job, _seeded_ask_id, _seeded_jobs_untouched_check, _skill_binding_check, assert_parked_in_request_world, assert_the_ask_falls_one_short, assert_the_registry_holds, assert_values_are_new, seed_parked_in_request
