...
The round was demonstrated and the routine minted; the user says yes. The turn stands the job up
on the round's own container -- parameters bound from the demonstration, the cadence set from
what the ask asked for, and an end condition composed where one was named.
"""
