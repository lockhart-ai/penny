...
Every parked state bails back to idle when the user drops the task -- elicit mid-question, learn
mid-demonstration, request mid-binding (including one where the binding was half settled). The
turn answers the new subject and leaves nothing half-built behind it. The fifth case is the
floor: ordinary banter in idle, which fires nothing at all.
"""
