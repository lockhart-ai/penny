...
class TestDeviceStore:
    ...
    def test_register_creates_device(self, db):
    ...
    def test_register_with_default(self, db):
    ...
    def test_register_default_clears_prior_default(self, db):
    ...
    def test_register_upsert_returns_existing(self, db):
    ...
    def test_get_by_identifier(self, db):
    ...
    def test_get_by_identifier_not_found(self, db):
    ...
    def test_set_default_clears_others(self, db):
        signal = db.devices.register(ChannelType.SIGNAL, "+15551234567", "Signal", is_default=True)
