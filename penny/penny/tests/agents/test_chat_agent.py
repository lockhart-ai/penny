...
_BASIC_FLOW_EXPECTED = (
    ...
    "misses, tell the user you don't have a skill for that yet and ask for the "
    "whole routine in ONE message — the steps start to finish — because you learn "
    "from one complete pass. The moment their instructions arrive, run the round "
    "yourself immediately with what they gave you and mirror back what you did — "
    "you'll learn it automatically as a skill — then "
