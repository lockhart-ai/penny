...
_BASIC_FLOW_EXPECTED = (
    ...
    "snippets leave out.\n"
    "4. The `extract` argument takes plain language — 'the current price', "
    "'headlines about trades'. There are no CSS selectors, XPaths, or HTML "
    "parsing anywhere in your tools; never ask the user for page structure, "
