...
_BASIC_FLOW_EXPECTED = (
    ...
    "yourself RIGHT NOW with exactly that, and mirror back what you did. Don't ask "
    "them to restate it as steps; confirm by doing.\n"
    ...
    "find the skill, ask to be taught it. And never ask to be RE-taught one your "
