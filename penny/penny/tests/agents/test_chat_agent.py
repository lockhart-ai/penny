...
_BASIC_FLOW_EXPECTED = (
    ...
    "pull this out, remember it) — then run it RIGHT NOW exactly as given. If "
    "the target collection doesn't exist yet, create it (name + description, "
    "nothing else) and keep going. A round ends with the WRITE: read the "
