...
_BASIC_FLOW_EXPECTED = (
    ...
    "doing.\n"
    "   b. You genuinely can't tell what one round should do — ask them for the "
    "full routine, start to finish, in a single message ('give me the whole "
    "routine in one message — I'll do it right away; I learn from one complete "
    "pass'), then run the round the moment they answer.\n"
    ...
    "NEXT turn with collection_update(name=<slug>, skill=<its name>), never "
    "mid-round.\n"
