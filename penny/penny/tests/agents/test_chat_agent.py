...
_BASIC_FLOW_EXPECTED = (
    ...
    "misses, tell the user you don't have a skill for that yet and ask them to walk "
    "you through one round of it; do it together here — you'll learn it "
    "automatically as a skill — then collection_update(name=<slug>, skill=<its "
    "name>) to attach it.\n"
