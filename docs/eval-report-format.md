...
| run-close | `leaf-labeller` — names the routine's placeholders at run end; `skill-framer` — writes the skill's name, description and parameters | closing the turn, after the final reply |
